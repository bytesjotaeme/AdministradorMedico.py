...
ciudades=["La Plata", "Córdoba", "Rosario", "Mendoza", "San Miguel de Tucumán", "Mar del Plata", "Salta", "Santa Fe", "San Juan", "Resistencia", "San Salvador de Jujuy", "Corrientes"]
estados=["Buenos Aires", "Córdoba", "Santa Fe", "Mendoza", "Tucumán", "Entre Ríos"]
medicos=["José Rivas","Jose Jose"]
